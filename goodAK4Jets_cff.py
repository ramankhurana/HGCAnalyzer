...
cleanAK4Jets.checkOverlaps.muons.src = "goodMuonsForMET"
cleanAK4Jets.checkOverlaps.muons.deltaR = 0.4
cleanAK4Jets.checkOverlaps.muons.requireNoOverlaps = True
cleanAK4Jets.checkOverlaps.electrons.src = "goodElectronsForMET"
...
cleanAK4Jets.finalCut = "pt > 20 & abs(eta) < 3.0"
